...
export default async function AdminMensajesPage() {
  ...
  const ADMIN_EMAILS = ['vanguardiait@gmail.com', 'juanmab94@gmail.com'];
...
# Ruta base
base_path = "app/admin/mensajes"

# Ejecución
if __name__ == "__main__":
    write_file(f"{base_path}/page.tsx", page_content)
    write_file(f"{base_path}/ChatClient.tsx", client_content)
    write_file(f"{base_path}/actions.ts", actions_content)
    print("[SUCCESS] Sistema de Mensajeria Administrador materializado correctamente.")
