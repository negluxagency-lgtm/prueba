...
"""
    ...
    with open(os.path.join(base_dir, "not-found.tsx"), "w", encoding="utf-8") as f:
        f.write(page_content)
    print("INFO: not-found.tsx materialized successfully.")

if __name__ == "__main__":
    print("Inicializando propulsores. Leyendo directiva error_404...")
    materialize_files()
