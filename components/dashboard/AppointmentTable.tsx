...
export const AppointmentTable: React.FC<AppointmentTableProps> = ({ appointments, selectedDate, userPlan, onEdit, onDelete, onUpdateStatus, onGenerateInvoice, loading, barbers = [] }) => {
    ...
    return (
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg lg:rounded-[2rem] backdrop-blur-sm shadow-2xl relative">
            ...
            <div className="overflow-x-auto overflow-y-visible">
                <table className="w-full text-left border-collapse">
                    <thead className="text-zinc-500 text-[8px] lg:text-xs uppercase tracking-[0.2em] bg-black/40">
                        <tr>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Cliente</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Servicio</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Hora</th>
                            {(userPlan === 'Premium' || userPlan === 'Profesional') && (
                                <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Barbero</th>
                            )}
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Estado</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-amber-500/80 text-center">Precio</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">WhatsApp</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-zinc-400/80 text-center">Pago</th>
                            <th className="px-2 py-1.5 lg:px-4 lg:py-3 font-bold text-center">Acciones</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-zinc-800/40">
                        {loading ? (
                            ...
                            Array.from({ length: 5 }).map((_, i) => (
                                <tr key={i}>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-5 w-24 lg:w-32 mx-auto" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-4 w-16 lg:w-24 mx-auto" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-5 w-12 lg:w-16 mx-auto" /></td>
                                    {(userPlan === 'Premium' || userPlan === 'Profesional') && (
                                        <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-4 w-16 lg:w-24 mx-auto" /></td>
                                    )}
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-7 w-20 lg:w-24 mx-auto rounded-lg" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-5 w-8 lg:w-12 mx-auto" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-7 w-16 lg:w-20 mx-auto rounded-lg" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><Skeleton className="h-6 w-12 lg:w-16 mx-auto rounded-lg" /></td>
                                    <td className="px-2 py-4 lg:px-4 lg:py-3 text-center"><div className="flex justify-center"><Skeleton className="h-7 w-7 rounded-lg" /></div></td>
                                </tr>
                            ))
                        ) : (
                                ...
                                {appointments.length > 0 ? (
                                    appointments.map((cita, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-2 py-1 lg:px-4 lg:py-3 text-amber-500 text-[11px] lg:text-sm font-bold text-center">
                                            ...
                                            <td className="px-2 py-1 lg:px-4 lg:py-3 text-center">
                                                <div className="relative inline-block">
                                                    <button
                                                        ...
                                                        className={`inline-flex items-center gap-1 lg:gap-1.5 px-2 py-1 lg:px-3 lg:py-1.5 rounded-lg text-[7px] lg:text-[10px] font-black transition-all border ${cita.cancelada
                                                    ...
                                                    >
                                                        <Check className={`w-2 h-2 lg:w-3 lg:h-3 opacity-100`} strokeWidth={4} />
                                            ...
                                            <td className="px-2 py-1 lg:px-4 lg:py-3 text-center">
                                                {cita.Telefono ? (
                                                    ...
                                                    <span className="text-zinc-600 text-[7px] lg:text-xs italic">Sin Tlf</span>
                                                )}
                                            </td>
                                            <td className="px-2 py-1 lg:px-4 lg:py-3 text-center">
                                                {cita.pago ? (
                                                    <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 lg:px-2 lg:py-1 rounded-lg border text-[7px] lg:text-[10px] font-black uppercase tracking-widest ${PAGO_COLORS[cita.pago] || PAGO_COLORS.otra}`}>
                                                        {PAGO_ICONS[cita.pago]}
                                                        <span className="hidden lg:inline">{cita.pago}</span>
                                                    </span>
                                                ) : (
                                            ...
                                            <td className="px-2 py-1 lg:px-4 lg:py-3 text-center">
                                                <button
                                                    ...
                                                    className="p-1.5 lg:p-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-amber-500 rounded-lg transition-all border border-zinc-700/50 hover:border-amber-500/50"
                                                >
                                    ...
                                    <tr>
                                        <td colSpan={(userPlan === 'Premium' || userPlan === 'Profesional') ? 9 : 8} className="px-8 py-10 text-center text-zinc-600 italic uppercase tracking-widest text-[9px] lg:text-xs">
                                            Sin citas hoy
                                        </td>
                                    </tr>
                                )}
                        ...
                        {menuState.type === 'status' ? (
                            <div className="bg-zinc-950">
                                <button
                                    ...
                                    className="w-full text-left px-3 py-2 lg:px-4 lg:py-3 text-[9px] lg:text-xs font-bold text-amber-500 hover:bg-zinc-800/80 transition-colors flex items-center gap-2 lg:gap-3"
                                >
                                    <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)]"></div>
                                    PENDIENTE
                                </button>
                                <button
                                    onClick={() => handleConfirmClick(activeAppointment.id)}
                                    className="w-full text-left px-3 py-2 lg:px-4 lg:py-3 text-[9px] lg:text-xs font-bold text-green-500 hover:bg-zinc-800/80 transition-colors flex items-center gap-2 lg:gap-3 border-t border-zinc-800/50"
                                >
                                    <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]"></div>
                                    CONFIRMADA
                                </button>
                                <button
                                    onClick={() => {
                                    ...
                                    className="w-full text-left px-3 py-2 lg:px-4 lg:py-3 text-[9px] lg:text-xs font-bold text-red-500 hover:bg-zinc-800/80 transition-colors flex items-center gap-2 lg:gap-3 border-t border-zinc-800/50"
                                >
                                    <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]"></div>
                                    CANCELADA
                                </button>
                            </div>
                        ) : (
                            <div className="p-1">
                                {onGenerateInvoice && (
                                    <button
                                        ...
                                        className="w-full text-left px-3 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs font-bold text-white hover:bg-amber-500 hover:text-black transition-all flex items-center gap-3 group"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-3 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs font-bold text-zinc-400 hover:bg-white/10 hover:text-white transition-all flex items-center gap-3"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-3 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs font-bold text-red-500/70 hover:bg-red-500/10 hover:text-red-500 transition-all flex items-center gap-3 border-t border-zinc-800/50 mt-1 pt-2"
                                >
