    ...
    const handleAdd = async () => {
        ...
        try {
            const { error } = await supabase.from('horas_extra').insert({
                ...
                precio_hora_extra: 0, // No longer used for money
        ...
        <div className="mt-4 pt-4 border-t border-zinc-800/50">
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2 text-zinc-400">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Control de Horas Extra</span>
                </div>
                {!showForm && (
                    <button
            ...
            <div className="space-y-2">
                {loading ? (
                    ...
                    <p className="text-[10px] text-zinc-600 italic text-center py-1">Sin horas registradas este mes</p>
                ) : (
                    records.map(r => (
